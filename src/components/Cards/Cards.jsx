...
const Cards = () => {
  ...
  useEffect(() => {
    fetch("https://chef-hunter-a10-server-nasfatema99-gmailcom.vercel.app/chefs")
      .then((res) => res.json())
  ...
  return (
    <Container>
      <div className="text-center">
        <h1>Our Top Cook</h1>
        <p>
          Experience the joy of food exploration with our website, where you can
          find endless inspiration, delicious recipes, and insider tips from top
